...
typedef struct
{
     ...
     *                - If pLabel = "master secret", HSE computes the master secret; the hseKdfTLS12PrfScheme_t#keyMatLength should be 48 bytes.
     *                - If pLabel=  "key expansion", HSE computes the key_block; the hseKdfTLS12PrfScheme_t#keyMatLength should be >= 32 bytes.
